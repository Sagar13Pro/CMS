...
$user_id = User::select('id')->where('email',session()->get('session_mail'))->get();
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle pl-md-3 position-relative" id="read"
                                href="javascript:void(0)" id="bell" role="button" data-toggle="dropdown"
                                ...
                                <ul class="list-style-none">
                                    <li>
                                        <div class="message-center notifications position-relative">
                                            ...
                                            <a href="{{ route('user.notified.read',[$item->notifiable_id,$item->id]) }}"
                                                class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                <div class="btn btn-danger rounded-circle btn-circle"><i
                                                        data-feather="airplay" class="text-white"></i></div>
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h6 class="message-title mb-0 mt-1"> {{ $item->data['Status'] }}<br>
                                                        {{ $item->data['Remarks'] }}</h6>
                                                    <span class="font-12 text-nowrap d-block text-muted"> {{
                                                        $item->data['CompID'] }}</span>
                                                    <span class="font-12 text-nowrap d-block text-muted">{{
                                    ...
                                    <li>
                                        <a class="nav-link pt-3 text-center text-dark"
                                            href="{{ route('user.notified.read',session('user_id')) }}">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark">{{ session()->get('session_name') }}</span> <i
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ route('newcomplaint.view') }}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ route('trackcomplaint.view') }}"
                                aria-expanded="false">
                ...
                <div class="card-group">
                                ...
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-orange mb-1 font-weight-medium count">{{
                                            userComp::select('status')->where('foreignEmail',session('session_mail'))->count()
                                            }}</h2>

                                    </div>
                                    <h6 class="text-white font-weight-medium mb-0 w-100 text-truncate">Total Complaint
                                    </h6>
                                </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-green mb-1 w-100 text-truncate font-weight-medium count">{{
                                        userComp::select('status')->where('status','Solved')->where('foreignEmail',session('session_mail'))->count()
                                        }}</h2>
                                ...
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-primary mb-1 font-weight-medium count">{{
                                            userComp::select('status')->where('status','Pending')->where('foreignEmail',session('session_mail'))->count()
                                            }}</h2>

                                        <!--span
                                            class="badge bg-danger font-12 text-white font-weight-medium badge-pill ml-2 d-md-none d-lg-block">-18.33%</span-->
                                    </div>
                                    <h6 class="text-white font-weight-normal mb-0 w-100 text-truncate">Pending
                                        Complaints</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card red">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-danger mb-1 font-weight-medium count">{{
                                        userComp::select('status')->where('status','Closed')->where('foreignEmail',session('session_mail'))->count()
                                        }}</h2>

                                    <h6 class="text-white font-weight-normal mb-0 w-100 text-truncate">Closed Complaints
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                            @php $details =
                                            userComp::all()->where('foreignEmail',session('session_mail')); @endphp
                                            @if(count($details) == 0)
                                            @else
                                            @foreach($details as $item)
                                            <tr>
                                                <td
                                                    class="border-top-0 text-center font-weight-medium text-dark px-2 py-4">
                                                    @if ($item->isMerged)
                                                    Yes
                                                    @else
                                                    No
                                                ...
                                                <td
                                                    class="border-top-0 text-dark text-center px-2 py-4 font-weight-medium ">
                                                    <b>{{ $item->Complaint_ID }}</b>
                                                </td>
                                                <td
                                                    class="border-top-0 text-dark text-center px-2 py-4 font-weight-medium">
                                                    {{ $item->ComplaintDate }}</td>
                                                <td
                                                    class="border-top-0 text-dark text-center px-2 py-4 font-weight-medium">
                                                    {{ $item->status }}</td>
                                                ...
                                                <td
                                                    class="text-center font-weight-medium text-dark border-top-0 px-2 py-4">
                                                    @if(is_null($details))
                                                    @else
                                                    @php
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light" data-dismiss="modal"><i data-feather="x"
                                    class="feather-icon"></i> Close</button>
                            <a href="{{ route('user.logout') }}" class="btn btn-primary"><i data-feather="log-out"
